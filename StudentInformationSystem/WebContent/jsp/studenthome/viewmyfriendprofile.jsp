	...
	<div class="panel-body" align="center">
		...
		<div class="col-lg-8">
	  		<form class="form-horizontal">
		 		...
		 		<div class="form-group">
		 			<div class="col-lg-5" align="center" ><input class="form-control btn-primary" type="button" name="addfriend" value="Add Friend" onclick="addtomyfriendslist(<%= response.getHeader("sid") %>)"/></div>
		 		</div>	
