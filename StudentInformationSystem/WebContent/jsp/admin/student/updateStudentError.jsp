...
<!-- Container for the entire page -->
		<div class="panel panel-primary">
			...
			<!-- Screen heading -->
			<div class="panel-heading" align="center"><h3>Update Student Registration: User Already Exists with the given Roll no./Username</h3></div>
					...
					<form class="form-horizontal" method="post" enctype="multipart/form-data" name="updateform" id="updateform">
						<fieldset>
							...
							<div class="row" align="center">
								<div class="col-lg-12">
									<input type="button" class="btn btn-primary" value="submit" onclick="updatestudentscript(this.form)">
								</div>
							</div>
