...
<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
		...
		<div class="panel panel-primary">
			...
			<!-- Screen heading -->
			<div class="panel-heading" align="center"><h3>Update Enrollment</h3></div>
					 ...
					 <form class="form-horizontal" method="post" enctype="multipart/form-data" name="myform" id="myform">
						...
						<br>
							...
							<div class="row">
								...
								<div class="col-lg-1"></div>
								<div class="col-lg-4" align="left">
									<input type="text" class="form-control" name="cname" placeholder="Course Name" id="cname" readonly="readonly" value="${list[0].cname}" required>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-4" id="show" align="left">
									<input type="text" class="form-control" name="sname" placeholder="Student Name" readonly="readonly" value="${list[0].sname}" id="sname" required>
								</div>
							</div>
