...
<style type="text/css">
	...
	<div class="panel panel-primary" >
		...
		<div class="panel-heading" style="font-size: 20px"><b>Course Updated Successfully!!  </b></div><br/>
	</div>
		<br><br>
	 	<form name="myForm2course" id="myForm2course" class="form-horizontal"  method="post"  enctype="multipart/form-data">
			...
			<div class="row">
					...
					<div class="col-lg-4" >	<s:radio  name="isactive" list="#{'1':'Active','0':'Inactive'}" value="isactive" /></div>
						...
						<br/><br/>
			<div class="row">
					<div class="col-lg-4" align="right"> <input  type="button" name="submit" id="submit" value="submit"  class="btn btn-primary" onclick="updatecoursescript(this.form)"></div>
