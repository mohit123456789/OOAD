...
<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
		...
		<div class="panel panel-primary">
			...
			<!-- Screen heading -->
			<div class="panel-heading" align="center"><h3>Update Assignment</h3></div>
						...
						<fieldset>
							...
							<div class="row">
								...
								<div class="col-lg-4" align="left">
									<input type="text" class="form-control" name="fname" placeholder="Faculty Name" id="fname" readonly="readonly" value="${list[0].fname}" required>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-4" id="show" align="left">
									<input type="text" class="form-control" name="cname" placeholder="Course Name" readonly="readonly" value="${list[0].cname}" id="cname" required>
								</div>
							</div>
							...
							<div class="row" align="center">
								<div class="col-lg-12" >
									<input id="submit" type="button" class="btn btn-primary" value="submit" onclick="updateassignmentscript(this.form)">
								</div>
							</div>
							<!-- 5th row ends here -->
